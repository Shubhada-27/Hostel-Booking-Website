...
<form action="owner_action.jsp" method="post">
  <div class="container";div style="background-color:white; color:black ; padding:20px;">
    ...
    <hr>
    <p align="center" >By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p><br/>

    <button type="submit" class="registerbtn"><strong>Register</strong></button><br/>
  </div>
  <div>
  </div>
  ...
  <div class="signin">
    ...
    <p>Already have an account? <a href="owner_login.jsp">Sign in</a>.</p><br/>
  </div>
</form>
</main>
</body>
