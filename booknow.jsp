...
con= DriverManager.getConnection("jdbc:mysql://localhost:3306/hostel","root","Shubhada@7788");
  ...
  <div class="col-75">
    <div class="container">
      <form action="booknow_action.jsp" onsubmit = "myFunction()" method="post">
        ...
        <label>
          <input type="checkbox" checked="checked" name="terms&privacy">I have read and agree all<a href="Privacy.html">Terms & Privacy</a>
        </label>
        <hr>
